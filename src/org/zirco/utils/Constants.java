...
public class Constants {
	...
	public static final String PREFERENCES_ML_FONTFIX = "MlFontFix";
	public static final String PREFERENCES_ML_FONTFIX_NO_FIX = "NOFIX";
	public static final String PREFERENCES_ML_FONTFIX_DEFAULT = "DEFAULT";
	public static final String PREFERENCES_ML_FONTFIX_ALT = "ALTERNATE";
