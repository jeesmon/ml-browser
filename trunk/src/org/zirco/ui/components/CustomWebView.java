...
public class CustomWebView extends WebView {
	...
	public void loadFontFix(String fixType) {
		if(!Constants.PREFERENCES_ML_FONTFIX_NO_FIX.equals(fixType)) {
			super.loadUrl(ApplicationUtils.getFontFixString(mContext, fixType));
		}
	}
